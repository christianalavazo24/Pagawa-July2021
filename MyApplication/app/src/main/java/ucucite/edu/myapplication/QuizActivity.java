package ucucite.edu.myapplication;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private Button mTrueButton, mFalseButton1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTrueButton = (Button)findViewById(R.id.trueButton1);
        mFalseButton1 = (Button)findViewById(R.id.falseButton1);
